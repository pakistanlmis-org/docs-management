<!-- Sidebar Menu -->
		<div id="menu" class="hidden-phone hidden-print">
			...
			<!-- Sidebar Profile -->
			<span class="profile">
				<a class="img" href="my-account.php"><img src="http://dummyimage.com/51x51/232323/ffffff&amp;text=photo" alt="<?php echo $_SESSION['username']; ?>" /></a>
				<span>
...
<!--			 Sidebar Mini Stats 
			...
			<ul>
				...
				<li class="large glyphicons file"><a href="files.php"><i></i><span>File Management</span></a></li>
				<li class="large glyphicons log_book"><a href="tracking.php"><i></i><span>File Tracking</span></a></li>
