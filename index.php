    ...
    <body class="login">
        ...
        <div id="login">
            ...
            <div class="form-signin">
                    ...
                    <div class="span12">
                        <div class="inner">
                            ...
                            <form method="post" action="login.php">
                                ...
                                <input type="text" name="username" class="input-block-level" placeholder="Your Username or Email address"/> 
                ...
                <div class="ribbon-wrapper"><div class="ribbon primary">eDocs</div></div>
            </div>
            <!-- // Box END -->
